...
def comp_synth(games, get_strat=False):
    ...
    #game_latches = map(lambda g: map(lambda l: l.lit,
    #    list(g.aig.iterate_latches())), games)
    #print "LATCHES of subgames:"
    #for l in game_latches:
    #    print l
    #print "CINPUTS of subgames"
    #for l in cinputs:
    #    print l
